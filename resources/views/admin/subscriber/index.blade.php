            ...
            <table class="table table-hover table-bordered mg-b-0 mb-5">
                ...
                @foreach($subscribers as $subscriber)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('delete.subscriber', $subscriber->id) }}" id="delete" class="btn btn-danger"><i class="fa fa-times"></i></a>
                            <a href="{{ route('formMail.subscriber', [$subscriber->user_email, $subscriber->user_name]) }}" class="btn btn-info"><i class="fa fa-envelope"></i></a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
